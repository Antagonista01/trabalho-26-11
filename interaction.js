...
let tudo = "";
let coisas = document.getElementById("itens_section");
let prin = document.getElementById("sessao-venda");
for(itens of ITENS_LOJA)
{
    coisas.innerHTML = "<div>"+"<img src="+itens.url_img+">"+"<h1>"+ itens.nome +"</h1>"+"<article>" + "<h2>Preço:</h2><p> R$"+ itens.preco +"</p>"+"</article>"+"<p> Descrição: "+ itens.descricao +"</p>"+"</div>";
    tudo = tudo + coisas.innerHTML;
}
coisas.innerHTML = tudo;